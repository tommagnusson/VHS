...
public class Pets {
	public static void main(String Args[]) {
		Dog fido = new Dog("Fido", Gender.MALE, 45);
		Snake sam = new Snake("Sam", Gender.MALE, 6);
